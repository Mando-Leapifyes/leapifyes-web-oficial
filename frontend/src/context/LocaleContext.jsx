...
export const TRANSLATIONS = {
  es: {
    ...
    empresa: {
      ...
      hist_p1: 'Leapifyes nació para resolver un problema real: miles de pymes, autónomos y emprendedores que se sienten fuera de lugar en lo digital. El papeleo, la burocracia y el miedo a la tecnología les quitan tiempo, clientes y tranquilidad.',
      hist_p2: 'Creemos que la transformación digital no puede ser un lujo: debe ser simple y cercana. No somos consultores que hablan difícil. Somos tu socio digital.',
      ...
      founder_role: 'Fundador y CEO de Leapifyes',
      founder_bio_1: 'Transformador digital con visión humana. Ricardo Serrano creó Leapifyes porque miles de pymes lo necesitan. Entendió, desde la calle y desde dentro, que la transformación digital no puede seguir siendo un lujo para unos pocos ni una moda de palabras vacías.',
      founder_bio_2: 'Con más de una década trabajando directamente con negocios, vio una realidad que se repetía: empresas con talento y potencial, pero sin herramientas. Negocios con ganas de crecer, pero atrapados en sistemas obsoletos.',
      founder_bio_3: 'Así nació Leapifyes: de la obsesión por unir lo digital con lo humano y transformar la tecnología en una aliada accesible, útil y rentable para cada pequeño empresario.',
      founder_bio_4: 'Como ideólogo de Leapifyes, defiende una visión clara: acompañar sin imponer, hablar el idioma del cliente y ofrecer soluciones digitales con propósito, corazón y resultados.',
      team_title: 'Nuestro Equipo',
      team_sub: 'Un equipo multidisciplinar que combina tecnología, negocio y mucha empatía.',
      team_tech_title: 'Equipo Técnico',
      team_tech_desc: 'Desarrolladores, arquitectos de soluciones y especialistas en IA con experiencia en proyectos reales.',
      team_biz_title: 'Consultores de Negocio',
      team_biz_desc: 'Profesionales con background en operaciones, estrategia y transformación de PYMEs.',
      team_success_title: 'Customer Success',
      team_success_desc: 'Equipo dedicado a asegurar que cada cliente consiga los resultados esperados.',
      bcn_title: 'Barcelona, nuestra casa',
      bcn_label: 'BCN',
      bcn_desc: 'Conocemos el tejido empresarial catalán, sus retos y oportunidades. En Leapifyes hablamos tu idioma y entendemos tu cultura de negocio.',
      bcn_q_title: '¿Por qué Barcelona?',
      bcn_points: [
        'Presencia local con mentalidad global',
        'Red de partners y proveedores de confianza',
        'Conocimiento profundo del mercado catalán',
        'Soporte en catalán, castellano e inglés'
      ],
      cta_title: '¿Conectamos?',
      cta_sub: 'En Leapifyes nos encanta conocer nuevos proyectos. Cuéntanos qué tienes en mente.',
      cta_primary: 'Agendar diagnóstico gratuito',
      cta_secondary: 'Contactar con el equipo'
    },
    data: {
      services: [
        {
  ...
  en: {
    ...
    empresa: {
      ...
      hist_p1: 'Leapifyes was born to solve a real problem: thousands of SMEs and freelancers who feel out of place in digital. Paperwork, bureaucracy and fear of technology take away time, clients and tranquility.',
      hist_p2: 'We believe digital transformation cannot be a luxury: it must be simple and close. We are not consultants who talk difficult. We are your digital partner.',
      ...
      founder_role: 'Founder and CEO of Leapifyes',
      founder_bio_1: 'Digital transformer with a human vision. Ricardo Serrano created Leapifyes because thousands of SMEs need it. He understood, from the street and from within, that digital transformation cannot continue to be a luxury for a few or a fashion of empty words.',
      founder_bio_2: 'With more than a decade working directly with businesses, he saw a reality that repeated itself: companies with talent and potential, but without tools. Businesses with a desire to grow, but trapped in obsolete systems.',
      founder_bio_3: 'That\'s how Leapifyes was born: out of an obsession to join digital with human and transform technology into an accessible, useful, and profitable ally for every small entrepreneur.',
      founder_bio_4: 'As the idealogist of Leapifyes, he defends a clear vision: accompany without imposing, speak the client\'s language, and offer digital solutions with purpose, heart, and results.',
      team_title: 'Our Team',
      team_sub: 'A multidisciplinary team combining technology, business, and a lot of empathy.',
      team_tech_title: 'Technical Team',
      team_tech_desc: 'Developers, solution architects, and AI specialists with experience in real projects.',
      team_biz_title: 'Business Consultants',
      team_biz_desc: 'Professionals with background in operations, strategy, and transformation of SMEs.',
      team_success_title: 'Customer Success',
      team_success_desc: 'Dedicated team to ensure each client achieves expected results.',
      bcn_title: 'Barcelona, our home',
      bcn_label: 'BCN',
      bcn_desc: 'We know the Catalan business fabric, its challenges and opportunities. In Leapifyes we speak your language and understand your business culture.',
      bcn_q_title: 'Why Barcelona?',
      bcn_points: [
        'Local presence with global mindset',
        'Network of trusted partners and suppliers',
        'Deep knowledge of the Catalan market',
        'Support in Catalan, Spanish, and English'
      ],
      cta_title: 'Connect?',
      cta_sub: 'At Leapifyes we love learning about new projects. Tell us what you have in mind.',
      cta_primary: 'Book free diagnosis',
      cta_secondary: 'Contact the team'
    },
    data: {
      services: [
        {
