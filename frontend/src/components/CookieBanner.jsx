        ...
        {!showSettings ? (
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold text-white">{t('cookies', 'settings_title')}</h2>
              <button
            ...
            <div className="space-y-4 mb-6">
              <CookieOption
                title={t('cookies', 'tech_title')}
                description={t('cookies', 'tech_desc')}
                checked={true}
                disabled={true}
                testId="cookie-opt-technical"
              />
              <CookieOption
                title={t('cookies', 'ana_title')}
                description={t('cookies', 'ana_desc')}
                checked={settings.analytics}
                onChange={(v) => setSettings({ ...settings, analytics: v })}
                testId="cookie-opt-analytics"
              />
              <CookieOption
                title={t('cookies', 'mark_title')}
                description={t('cookies', 'mark_desc')}
